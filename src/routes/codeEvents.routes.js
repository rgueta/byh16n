...
// router.get('/:userId/:start/:end',[authJwt.verifyToken,authJwt.isAdmin],codeEventsCtrl.getCode_events);
router.get('/:userId/:start/:end',codeEventsCtrl.getCode_events);
